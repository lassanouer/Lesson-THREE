...
public class Module3Job {
	...
	public static void logSessionByTimeout(String filename) {
		...
		JavaPairRDD<String, SessionLogDTO> lsession = lInput
				...
				.reduceByKey((a, b) -> reduceByTimeout(a, b));
	...
	public static SessionLogDTO reduceByTimeout(SessionLogDTO iSession_1, SessionLogDTO iSession_2) {
		...
		// tester la difference entre les dates par le timeout
		if (lDuree > Long.parseLong(BundelUtils.get("timeout"))) {
