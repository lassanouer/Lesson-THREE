...
public class Module2Job {
	...
	public static void logToSessionsByDay(String filename) {
		...
		JavaPairRDD<String, SessionLogDTO> lsession = lInput
				...
				.reduceByKey((a, b) -> reduceByIpAndDay(a, b));
	...
	public Date getDateCnx(SessionLogDTO iSession) {
		return iSession.getmD_Connection();
	}
	...
	public static SessionLogDTO reduceByIpAndDay(SessionLogDTO iSession_1, SessionLogDTO iSession_2) {
		...
		if (DateUtils.isSameDay(iSession_1.getmD_Connection(), iSession_2.getmD_Connection())) {
